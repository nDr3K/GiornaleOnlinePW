	...
	<div class="row row-cols-1 row-cols-md-1 g-4" style="margin-top: 10px; margin-left: 150px; margin-right: 150px; margin-bottom: 10px; text-align: center; justify-content: center">
			<div class="col">
				<div class="card h-100 bordo">
					<div class="card-body">
						<button class="btn categorie" type="button" onclick="showElements('favorites')">I MIEI PREFERITI</button>
					</div>
				</div>
			</div>
		</div>
		<div id="favorites" class="row row-cols-1 row-cols-md-1 g-4" style="margin-left: 150px; margin-right: 150px; border-radius: 5px; display:none">
			<div class="card">
				<div class="card-body">
					<table id="divPreferiti" class="table">
			...
			<div class="form-holder ">
				<div class="form-content">
					<div class="form-items">
						...
						<p></p>
						<form method="POST" action="user/stuff" action="articleform/savearticle" accept-charset="ISO-8859-1">
							<div class="row">
								<div class="col-12">
