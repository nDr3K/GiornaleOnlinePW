			...
			<div class="row row-cols-1 row-cols-md-1 g-4" style="margin-top: 10px; margin-left: 150px; margin-right: 150px; margin-bottom: 10px; text-align: center; justify-content: center">
				<div class="col">
					<div class="card h-100 bordo">
						<div class="card-body">
							<button class="btn categorie" type="button">${category.description}</button>
						</div>
					</div>
				</div>
			</div>
			<div class="row row-cols-1 row-cols-md-1 g-4 elementsContent" style="margin-left: 150px; margin-right: 150px; border-radius: 5px;">
				<div class="card">
					<div class="card-body">
						<table class="table">
